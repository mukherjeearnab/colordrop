...
namespace ColorPicker
{
	public partial class ColorPickerCtrl : UserControl
	{
		...
		void UpdateInfo()
		{
			...
			string info = string.Format("{0}, {1}, {2}", c.R, c.G, c.B);
            Color myColor = c;
        ...
        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            try
            {
                Color cms = System.Drawing.ColorTranslator.FromHtml(textBox1.Text);
                m_selectedColor = cms;
                m_colorWheel.SelectedColor = cms;
                m_colorSample.Refresh();
                UpdateInfo();
            }
            catch { }
        ...
        private void m_eyedropColorPicker_Click(object sender, EventArgs e)
        {
